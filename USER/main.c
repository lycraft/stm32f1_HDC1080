...
//=========================================================================方波发生
			if(mode % 4 == 3)
		{
			...
			delay_ms(100);
//			OLED_DrawBMP(0,0,128,8,GIF10);
//			delay_ms(100);
//			OLED_DrawBMP(0,0,128,8,GIF11);
//			delay_ms(100);
//			OLED_DrawBMP(0,0,128,8,GIF12);
//			delay_ms(100);
//			OLED_DrawBMP(0,0,128,8,GIF13);
//			delay_ms(100);
//			OLED_DrawBMP(0,0,128,8,GIF14);
//			delay_ms(100);
//			OLED_DrawBMP(0,0,128,8,GIF15);
//			delay_ms(100);
//			OLED_DrawBMP(0,0,128,8,GIF16);
//			delay_ms(100);
//			OLED_DrawBMP(0,0,128,8,GIF17);
//			delay_ms(100);
//			OLED_DrawBMP(0,0,128,8,GIF18);
//			delay_ms(100);
//			OLED_DrawBMP(0,0,128,8,GIF19);
//			delay_ms(100);
//			OLED_DrawBMP(0,0,128,8,GIF20);
//			delay_ms(100);
//			OLED_DrawBMP(0,0,128,8,GIF21);
//			delay_ms(100);
//			OLED_DrawBMP(0,0,128,8,GIF22);
//			delay_ms(100);
//			OLED_DrawBMP(0,0,128,8,GIF23);
//			delay_ms(100);
//			OLED_DrawBMP(0,0,128,8,GIF24);
//			delay_ms(100);
//			OLED_DrawBMP(0,0,128,8,GIF25);
//			delay_ms(100);
//			OLED_DrawBMP(0,0,128,8,GIF26);
//			delay_ms(100);
//			OLED_DrawBMP(0,0,128,8,GIF27);
//			delay_ms(100);
//			OLED_DrawBMP(0,0,128,8,GIF28);
//			delay_ms(100);			
//			OLED_DrawBMP(0,0,128,8,GIF29);
//			delay_ms(100);			
		}
	}	  
}
